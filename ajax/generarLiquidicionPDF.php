...
if (isset($dataLiquidacion)) {
  ...
  $info = [
    ...
    "meses" => ["nom_mesactual" => $datameses[0]["mes"], "nom_mesanterior" => $datameses[1]["mes"], "nom_anterior2" => $datameses[2]["mes"], "mesactual_impuesto_renta" => redondear($datameses[0]["impuesto_renta"]), "mesanterior_impuesto_renta" => redondear($datameses[1]["impuesto_renta"]), "mesanterior2_impuesto_renta" => redondear($datameses[2]["impuesto_renta"]), "mesactual_impuesto_igv" => redondear($datameses[0]["impuesto_igv"]), "mesanterior_impuesto_igv" => redondear($datameses[1]["impuesto_igv"]), "mesanterior2_impuesto_igv" => redondear($datameses[2]["impuesto_igv"])],
