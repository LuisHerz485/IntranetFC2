...
(1, 1, 'Revisión Mensual y/o Anual', 'Determinación y/o revisión del cumplimiento tributario mensual y/o anual.', 110.5),
(2, 1, 'Diagnóstico y Planeamiento Tributario', 'Diagnóstico y Planeamiento Tributario para detectar posibles contingencias.', 110.5),
(3, 1, 'Libros físicos y electrónicos', 'Elaboración, actualización y asesoría en la implementación de libros físicos y electrónicos.', 110.5),
(4, 1, 'Tributos', 'Asistencia en Procedimientos de Compensación, Devolución y/o Recuperación de tributos.', 110.5),
(5, 1, 'SPOT', 'Control de operaciones sujetas al SPOT.', 110.5),
(6, 1, 'Fiscalización y Defensa tributaria', 'Apoyo en procesos de fiscalización y Defensa tributaria.', 110.5),
(7, 1, 'Consultoría', 'Consultoría tributaria permanente.', 110.5),
(8, 1, 'Capacitación', 'Capacitación In-House en Materia Tributaria.', 110.5),
(9, 1, 'Outsourcing Tributario', 'Outsourcing Tributario.', 110.5),
(10, 1, 'Fiscalizaciones tributarias', 'Atención de fiscalizaciones tributarias.', 110.5),
(11, 1, 'Consultoría y auditoria tributaria', 'Consultoría y auditoria tributaria.', 110.5),
(12, 1, 'Asistencia empresarial', 'Brindar asistencia en la toma de decisiones empresariales, con el objeto de lograr el menor costo tributario y el menor nivel de contingencia tributaria posible.', 110.5),
(13, 2, 'Operaciones y /o transacciones contables.', 'Control, revisión, registro y proceso de operaciones y /o transacciones contables.', 110.5),
(14, 2, 'Control administrativo y contable', 'Revisión y evaluación de control administrativo y contable.', 110.5),
(15, 2, 'Generación de libros contables', 'Proceso y generación de libros contables: oficiales y auxiliares.', 110.5),
(16, 2, 'Análisis de cuentas y reportes gerenciales', 'Análisis de cuentas y reportes gerenciales.', 110.5),
(17, 2, 'Implementación de adopción de NIIF', 'Implementación de adopción de NIIF.', 110.5),
(18, 2, 'Actualización de la aplicación de NIIF', 'Actualización de la aplicación de NIIF.', 110.5),
(19, 2, 'Elaboración de presupuestos', 'Elaboración de presupuestos.', 110.5),
(20, 2, 'Conceptualización de actividades empresariales', 'Conceptualización de actividades empresariales.', 110.5),
(21, 2, 'Financieros mensuales y anuales', 'Elaboración de estados financieros mensuales y anuales.', 110.5),
(22, 2, 'Presentación de libros electrónicos', 'Presentación de libros electrónicos.', 110.5),
(23, 3, 'Asesoramiento en Contratos y Problemas Laborales', 'Asesoramiento en Contratos y Problemas Laborales.', 110.5),
(24, 3, 'Planillas y boletas de pago mensuales ', 'Proceso en la elaboración de Planillas Mensuales y de la emisión de Boletas de Pago.', 110.5),
(25, 3, 'Proceso y Pago de CTS', 'Proceso y Pago de Compensación por Tiempo de Servicios (CTS).', 110.5),
(26, 3, 'Asesoramiento para Inspecciones Laborales', 'Asesoramiento para Inspecciones Laborales.', 110.5),
(27, 3, 'Gratificaciones, vacaciones y cálculo de trabajadores', 'Proceso de la provisión de gratificaciones, vacaciones y cálculo de participación de los trabajadores.', 110.5),
(28, 3, 'Diagnóstico preventivo y correctivo', 'Diagnóstico preventivo y correctivo.', 110.5),
(29, 3, 'Autoridad laboral y AFP', 'Cumplimiento de obligaciones ante la autoridad laboral y AFP.', 110.5),
(30, 3, 'AFFNet y PDT PLAME', 'Elaboración y declaración de AFFNet y PDT PLAME.', 110.5),
(31, 3, 'Elaboración y actualización de T-Registro', 'Elaboración y actualización de T-Registro.', 110.5),
(32, 3, 'Emisión de asientos contables', 'Emisión de asientos contables.', 110.5),
(33, 4, 'Búsqueda y Selección de Profesionales', 'Búsqueda y Selección de Profesionales.', 110.5),
(34, 4, 'Contratación y registro de Personal', 'Contratación y registro de Personal.', 110.5),
(35, 4, 'Gestión de contratación de Seguros Vida Ley', 'Gestión de contratación de Seguros Vida Ley.', 110.5),
(36, 4, 'Apertura de cuentas de depósito de CTS', 'Apertura de cuentas de depósito de CTS.', 110.5),
(37, 4, 'Recuperación de subsidios', 'Recuperación de subsidios.', 110.5),
(38, 4, 'Consultoría Organizacional', 'Consultoría Organizacional.', 110.5),
(39, 5, 'Planeamiento de la toma de inventario físico', 'Planeamiento de la toma de inventario físico.', 110.5),
(40, 5, 'Inventario físico', 'Elaboración del informe final de la toma de inventario físico.', 110.5),
(41, 5, 'Administración de carpeta digital y gestor documental', 'Administración de carpeta digital y gestor documental.', 110.5),
(42, 5, 'Servicio de facturación de ventas de bienes y/o servicios.', 'Servicio de facturación, por las operaciones de ventas de bienes y/o servicios.', 110.5),
(43, 5, 'Servicio de cobranzas y proceso de operaciones de cobranzas', 'Servicio de cobranzas, con relación a los procedimientos de control, registro y proceso de operaciones de cobranzas.', 110.5),
(44, 5, 'Manejo de campañas publicitarias y web', 'Manejo de campañas publicitarias y web.', 110.5),
(45, 5, 'Apoyo en manejo de CRM', 'Apoyo en manejo de CRM.', 110.5);
...
(1, 'FC Oro', 'Por definir.', 500.1),
(2, 'FC Plata', 'Negocios con ventas anuales de hasta S/. 300, 000. Comprobantes de ventas/compras máximo 150 por operación.', 400.1),
(3, 'FC Pro', 'Negocios con ventas anuales de hasta S/. 200, 000. Comprobantes de ventas/compras máximo 100 por operación.', 300.1),
(4, 'FC Inicia', 'Negocios con ventas anuales de hasta S/. 100, 000. Comprobantes de ventas/compras máximo 50 por operación.', 200.1);
