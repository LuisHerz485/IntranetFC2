        ...
        if (value.estado == 0) {
          $('#mostrarCobranza')
            ...
            .row.add([
              ...
              "<button class='btn btn-primary btn-xs btnActivarC' iddetallecobranza='" +
          ...
          $('#mostrarCobranza')
            ...
            .row.add([
              ...
              value.monto,
              value.fechavencimiento,
              "<button class='btn btn-danger btn-xs btnActivarC' iddetallecobranza='" +
                value.iddetallecobranza +
                "' idcobranza='" +
                value.idcobranza +
                "' indice=" +
                ...
                $.each(respuesta, function (index, value) {
                  $('#mostrarSubPagos > tbody').append(
                    '<tr><td>' +
                      ...
                      '</td><td>' +
                      value.monto_const +
                      '</td><td><a href="ajax/generarPDF.php?idconstancia=' +
                      value.idconstancia +
                      '" class="btn btn-warning btn-s" target="_blank"><i class="far fa-file-alt"></i></a> <button class="btn btn-info btn-s btnMostrarHisCob" idconstancia=' +
                      value.idconstancia +
                      " value='" +
                      index +
                      '\' data-dismiss="modal" data-toggle="modal" href="#modalDetHisCob"><i class="far fa-eye"></i></button></td></tr>'
                  );
          ...
          $('#mostrarPendiente')
            ...
            .row.add([
              '<div scope="row" class="text-center"><abbr title="Ver Detalles"><button class="btn btn-info btn-s btnMostraDetCob" idcobranza=' +
                ...
                " value='" +
                index +
                '\' data-toggle="modal" data-target="#modalDetCob"><i class="far fa-eye"></i></button></abbr> <abbr title="Constancia"><button id=\'btnEstado' +
                index +
                "' estado='0' idcobranza=" +
                value.idcobranza +
                ' class="btn btn-warning btn-s btnConstancia" target="_blank"><i class="fas fa-paste"></i></button></abbr></div>',
              value.ruc,
              value.razonsocial,
              value.plan,
              value.monto,
