$('#btnfiltrar1').on('click', function () {
    ...
    $.ajax({
      url: 'ajax/declaracionple.ajax.php',
      method: 'POST',
      ...
      success: function ({ respuesta }) {
        $('#tblDeclaracionSunatPle').DataTable().clear().draw();
        let rowestado;
        let rowopcion;
        $.each(respuesta, function (index, value) {
          if (value.estado === null) {
            rowopcion = `<abbr title="Declarar Fecha"><button class="btn btn-warning border" id="btnModalRegistrarDeclaracion" idestado="${value.idestado}" iddeclaracion="${value.iddeclaracionple}" fecha="${value.fechavencimiento}"><i class="far fa-calendar-check"></i></button></abbr>`;
          ...
          }else if (value.estado == 'Inactivos') {
            rowopcion = `<abbr title="Declarar Fecha"><button class="btn btn-warning border" id="btnModalRegistrarDeclaracion" iddetalledeclaracion="${
              value.iddetalledeclaracionsunatple
            }"  iddeclaracion="${value.iddeclaracionple}"  idestado="${
              value.idestado
            ...
            rowestado = `<h3><p class="badge badge-warning">Inactivos</p></h3>`;
          }
          $('#tblDeclaracionSunatPle')
            .DataTable()
            .row.add([
              rowopcion,
              value.ruc,
  ...
  $('#btnRegistrarDeclaracion1').on('click', function () {
  ...
  $('#btnEditarDeclaracion1').on('click', function () {
