            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active h5">Registro de Declaraciones Ple</li></b>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body panel-body">
                        <div class="container-fluid">
                            <form id="fomularioFiltroDeclaracion">
                                <div class="row">
                                    <input type="hidden" name="idtipodeclaracion" id="idtipodeclaracion" value="3">
                                    ...
                                    <div class="col-12 col-lg-3">
                                        <label>Opcion:</label>
                                        <button type="button" class="btn btn-outline-danger  btn-block" id="btnfiltrar1" name="btnfiltrar"><i class="fas fa-search"></i> Filtrar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-info" id="btnRegistrarDeclaracion1"><i class="fas fa-save"></i> Guardar</button>
            ...
            <div class="modal-body">
                <div class="container">
                    <form id="formEditarDeclaracionSunat">
                        <div class="row">
                            <input type="hidden" name="idtipodeclaracion" id="idtipodeclaracionEditar" value="3">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-info" id="btnEditarDeclaracion1"><i class="fas fa-save"></i> Guardar</button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-times"></i> Salir</button>
                </div>
            </div>
        </div>
