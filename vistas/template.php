...
<head>
  ...
  <link rel="stylesheet" href="vistas/css/csscalendario/fullcalendar.min.css">
  <link rel="stylesheet" href="vistas/plugins/clockpicker/css/bootstrap-clockpicker.css">
  ...
  <script src="vistas/js/jscalendario/fullcalendar.min.js"></script>
  <script src="vistas/js/jscalendario/es.js"></script>

  <script src="vistas/plugins/clockpicker/js/bootstrap-clockpicker.js"></script>
</head>
...
if (isset($_SESSION['iniciarSesion']) && $_SESSION['iniciarSesion'] == "ok") {
  ...
  if (isset($_SESSION['cliente']) && $_SESSION['cliente'] == "no") {
    switch ($_SESSION['idtipousuario']) {
      ...
      case 3: {
          $administradorRutas = ["escritorio", "usuarios", "tipousuario", "departamento", "asistencia", "clientes", "reportes", "consultaruc", "consultadni", "permisos", "permisos-pendientes", "checklist", "checklist-administrador", "menuAsistencia", "menuChecklist", "declaracionSunatTributaria", "declaracionSunatLaboral", "reportesDeclaracion", "pasaje", "listarpasaje"];
          include "vistas/modulos/paginas/administrador/menu.php";
      ...
      case 6: {
          $jefeAreaRutas = ["escritorio", "asistencia", "permisos", "checklist-jefe", "admindrive",   "consultaruc", "declaracionSunatTributaria", "declaracionSunatLaboral", "reportesDeclaracion", "cronogramaAnualSunat", "declaracionAnualSunat", "liquidaciones", "listarliquidaciones","declaracionple"];
...
?>
<script src="vistas/js/usuario.js?v=1.1"></script>
<script src="vistas/js/tipousuario.js?v=1.1"></script>
<script src="vistas/js/departamento.js?v=1.1"></script>
<script src="vistas/js/asistencia.js?v=1.1"></script>
<script src="vistas/js/reportes.js?v=1.1"></script>
<script src="vistas/js/clientes.js?v=2.2"></script>
...
<script src="vistas/js/servicio.js?v=1.1"></script>
<script src="vistas/js/economia.js?v=2.1"></script>
<script src="vistas/js/checklist.js?v=1.1"></script>
<script src="vistas/js/tiposervicio.js?v=1.1"></script>
<script src="vistas/js/permiso.js?v=2.1"></script>
<script src="vistas/js/subida.js?v=1.1"></script>
<script src="vistas/js/tardanzas.js?v=1.1"></script>
